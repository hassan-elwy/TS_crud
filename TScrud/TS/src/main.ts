...
let infoList:formData[]=[];
let count:number=0;
let isUpdate:boolean=false
let udpateIndex=-1;

let searchControl =document.getElementById("TaskTitle") as HTMLInputElement
let priority=document.getElementById("selectPriority") as HTMLInputElement
let dueDate=document.getElementById("dueDate") as HTMLInputElement
let descript=document.getElementById("Description") as HTMLInputElement
...
{ 
    let dangerSpan =document.getElementById("Form_Errorspan") as HTMLSpanElement
...
{
    let card=document.getElementById(`ca-${index}`)as HTMLElement
...
function TodoTranstions(index:number)
{
    let card=document.getElementById(`ca-${index}`)as HTMLElement
    let transGroup=card.querySelector('#transition_buttons')
    let ToProgress;
    ...
    ToProgress=transGroup?.querySelector("#ToProgress") as HTMLButtonElement
    ToComplete=transGroup?.querySelector("#ToComplete") as HTMLButtonElement
...
function ToProgressTranstions(index:number)
{
    let card=document.getElementById(`ca-${index}`)as HTMLElement
    let transGroup=card.querySelector('#transition_buttons')
    let ToTodo;
    ...
    ToTodo=transGroup?.querySelector("#ToTodo") as HTMLButtonElement
    ToComplete=transGroup?.querySelector("#ToComplete") as HTMLButtonElement
...
function ToCompleteTranstions(index:number)
{
    let card=document.getElementById(`ca-${index}`)as HTMLElement
    let transGroup=card.querySelector('#transition_buttons')
    let ToProgress;
